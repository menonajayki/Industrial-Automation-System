...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_multiple_task_execution_example" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#df325a1b#;
   pragma Export (C, u00001, "multiple_task_execution_exampleB");
   ...
   u00137 : constant Version_32 := 16#91809229#;
   pragma Export (C, u00137, "ada__real_timeB");
   u00138 : constant Version_32 := 16#1ad7dfc0#;
   pragma Export (C, u00138, "ada__real_timeS");
   u00139 : constant Version_32 := 16#96c62183#;
   pragma Export (C, u00139, "system__taskingB");
   u00140 : constant Version_32 := 16#256a579d#;
   pragma Export (C, u00140, "system__taskingS");
   u00141 : constant Version_32 := 16#0c334715#;
   pragma Export (C, u00141, "system__task_primitivesS");
   u00142 : constant Version_32 := 16#4e3ebb7e#;
   pragma Export (C, u00142, "system__os_interfaceS");
   u00143 : constant Version_32 := 16#0039537b#;
   pragma Export (C, u00143, "interfaces__c__stringsB");
   u00144 : constant Version_32 := 16#eda3d306#;
   pragma Export (C, u00144, "interfaces__c__stringsS");
   u00145 : constant Version_32 := 16#cc709166#;
   pragma Export (C, u00145, "system__task_primitives__operationsB");
   u00146 : constant Version_32 := 16#9723968e#;
   ...
   u00148 : constant Version_32 := 16#cf061228#;
   pragma Export (C, u00148, "system__float_controlS");
   u00149 : constant Version_32 := 16#6387a759#;
   pragma Export (C, u00149, "system__interrupt_managementB");
   u00150 : constant Version_32 := 16#26aedc33#;
   pragma Export (C, u00150, "system__interrupt_managementS");
   u00151 : constant Version_32 := 16#7bca5a8d#;
   pragma Export (C, u00151, "system__multiprocessorsB");
   u00152 : constant Version_32 := 16#1756ce67#;
   pragma Export (C, u00152, "system__multiprocessorsS");
   u00153 : constant Version_32 := 16#24ec69e6#;
   pragma Export (C, u00153, "system__os_primitivesB");
   u00154 : constant Version_32 := 16#280734e2#;
   pragma Export (C, u00154, "system__os_primitivesS");
   u00155 : constant Version_32 := 16#2f9cb76c#;
   pragma Export (C, u00155, "system__arith_64B");
   u00156 : constant Version_32 := 16#9d9eabfb#;
   pragma Export (C, u00156, "system__arith_64S");
   u00157 : constant Version_32 := 16#05c60a38#;
   pragma Export (C, u00157, "system__task_lockB");
   u00158 : constant Version_32 := 16#4e70667a#;
   pragma Export (C, u00158, "system__task_lockS");
   u00159 : constant Version_32 := 16#b8c476a4#;
   pragma Export (C, u00159, "system__win32__extS");
   u00160 : constant Version_32 := 16#ce7dfb56#;
   pragma Export (C, u00160, "system__task_infoB");
   u00161 : constant Version_32 := 16#5a49699d#;
   pragma Export (C, u00161, "system__task_infoS");
   u00162 : constant Version_32 := 16#4ddebf0b#;
   pragma Export (C, u00162, "system__tasking__debugB");
   u00163 : constant Version_32 := 16#d3b35c55#;
   ...
   u00166 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00166, "system__concat_3B");
   u00167 : constant Version_32 := 16#248a0db1#;
   ...
   u00170 : constant Version_32 := 16#ead5bc8c#;
   pragma Export (C, u00170, "system__tasking__stagesB");
   u00171 : constant Version_32 := 16#6153a6f3#;
   ...
   u00176 : constant Version_32 := 16#2e7731ce#;
   ...
   u00179 : constant Version_32 := 16#5ca174ae#;
   ...
   u00188 : constant Version_32 := 16#2ebb1120#;
   pragma Export (C, u00188, "system__tasking__rendezvousB");
   u00189 : constant Version_32 := 16#da433d5e#;
   pragma Export (C, u00189, "system__tasking__rendezvousS");
   u00190 : constant Version_32 := 16#886988be#;
   ...
   --  multiple_task_execution_example%b
